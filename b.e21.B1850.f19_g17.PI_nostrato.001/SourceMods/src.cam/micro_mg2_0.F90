...
real(r8)           :: micro_mg_max_nicons ! AMS (from JZ): PaleoClib
...
subroutine micro_mg_tend ( &
  ...
  micro_mg_max_nicons=1000.e3_r8 ! AMS (from JZ): PaleoCalib
  ...
  enddo
   ...
   ! AMS (from JZ): PaleoCalib, ice number limiter
     do k=1,nlev
        do i=1,mgncol
