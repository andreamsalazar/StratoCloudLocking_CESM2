...
RESTART_FILE=${4:-"b.e21.B1850.f19_g17.PaleoCalibr.PI.02"}
echo RES:$RES
echo COMPSET:$COMPSET
...
RUNDIR="${OUTPUT}/run"
RESTDIR="/glade/derecho/scratch/asalazar/piControl_PaleoCalib_restart"
...
./xmlchange --id RUN_REFDATE --val 0151-01-01
